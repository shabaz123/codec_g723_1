...
#if defined(_WIN32)
  #if defined(G723_STATIC)
    #define G723_EXPORT
  #elif defined(G723_BUILDING_DLL) || defined(g723_1_EXPORTS) || defined(codec_g723_1_EXPORTS)
    #define G723_EXPORT __declspec(dllexport)
  #elif defined(G723_IMPORT)
    #define G723_EXPORT __declspec(dllimport)
  #else
    #define G723_EXPORT __declspec(dllexport)
  #endif
#else
 ...
 * (or 480 samples if configured for 16000 Hz).
 *
 ...
 * at least 240 (or 480 for 16000 Hz).
 *
